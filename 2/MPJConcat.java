...
/*
	...
	administrator@it-nl-pc14:~/Downloads/mpi$ $MPJ_HOME/bin/mpjrun.sh -np 2 MPJConcat
	MPJ Express (0.44) is started in the multicore configuration
	Processor 0 has data: pes modern coe pune 
	Processor 0 has data: pes
	Processor 0 has data: modern
	Processor 0 is concatenating data
	Processor 1 has data: coe
	Processor 1 has data: pune
